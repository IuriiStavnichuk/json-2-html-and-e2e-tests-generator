...
function draw_chart (sorted_values){
    ...
    var arcs = svg.selectAll(".arc")
     ...
     var paths=arcs.append("path")
        .style("fill", function(d,i) { create_lines_array(i);return color(d.data.value1); })
    .transition()
        .duration(2000)
...
/*    .transition()
    ...
    var lineGraph = arcs.append("path")

        .attr(  "d", function(d,i) { console.log(d);return lineFunction(lineData[i]); }  )
...
/*lineData[0] = [ { "x": 0,   "y": 0},  { "x": 20,  "y": 20}];
lineData[1] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 40}];
lineData[2] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 50}];
lineData[3] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 60}];
lineData[4] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 180}];
lineData[5] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 80}];
lineData[6] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 90}];
lineData[7] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 100}];
lineData[8] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 120}];
lineData[9] = [ { "x": 1,   "y": 5},  { "x": 20,  "y": 80}];*/

function create_lines_array (i)
{
    lineData[i] = [ { "x": 0,   "y": 0},  { "x": (20+(3*i))*i,  "y": 20*i}];
}
